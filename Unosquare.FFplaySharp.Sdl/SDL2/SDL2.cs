...
namespace SDL2
{
    public static partial class SDL
	{
		...
		internal static partial IntPtr SDL_malloc(IntPtr size);
		 ...
		 */
		[LibraryImport(nativeLibName)]
		public static partial IntPtr SDL_LoadFile(IntPtr file, IntPtr datasize);
		...
		[LibraryImport(nativeLibName)]
		public static partial int SDL_WinRTRunApp(
		 ...
		 */
		[LibraryImport(nativeLibName)]
		public static partial int SDL_UIKitRunApp(
			int argc,
			IntPtr argv,
			SDL_main_func mainFunction
		);
		...
		[LibraryImport(nativeLibName)]
		private static partial void SDL_LogGetOutputFunction(
			out IntPtr callback,
			out IntPtr userdata
		);
		...
		/* userdata refers to a void* */
		[LibraryImport(nativeLibName)]
		public static partial void SDL_LogSetOutputFunction(
		...
		public static unsafe int SDL_ShowMessageBox(in SDL_MessageBoxData messageboxdata, out int buttonid)
		{
			...
			fixed (INTERNAL_SDL_MessageBoxButtonData* buttonsPtr = &buttons[0])
			{
				...
				result = INTERNAL_SDL_ShowMessageBox(in data, out buttonid);
			}
		...
		public static partial int SDL_SetWindowGammaRamp(
			IntPtr window,
			[MarshalAs(UnmanagedType.LPArray, ArraySubType = UnmanagedType.U2, SizeConst = 256)]
				in ushort[] red,
			[MarshalAs(UnmanagedType.LPArray, ArraySubType = UnmanagedType.U2, SizeConst = 256)]
				in ushort[] green,
			[MarshalAs(UnmanagedType.LPArray, ArraySubType = UnmanagedType.U2, SizeConst = 256)]
		 ...
		 */
		[LibraryImport(nativeLibName)]
		public static partial int SDL_SetWindowHitTest(
			IntPtr window,
		...
		[LibraryImport(nativeLibName, EntryPoint = "SDL_LoadBMP_RW")]
		private static partial IntPtr INTERNAL_SDL_LoadBMP_RW(
			IntPtr src,
			int freesrc
		);
		...
		/* IntPtr refers to an SDL_Surface* */
		/* THIS IS AN RWops FUNCTION! */
		[LibraryImport(nativeLibName, EntryPoint = "SDL_SaveBMP_RW")]
		private static partial int INTERNAL_SDL_SaveBMP_RW(
			IntPtr surface,
			IntPtr src,
			int freesrc
		);
		...
		private static unsafe partial int INTERNAL_SDL_SetClipboardText(
			byte* text
		);
...
#pragma warning restore 0169
		...
		/* userdata refers to a void* */
		[LibraryImport(nativeLibName)]
		private static partial SDL_bool SDL_GetEventFilter(
			out IntPtr filter,
			out IntPtr userdata
		);
		...
		/* userdata refers to a void* */
		[LibraryImport(nativeLibName)]
		public static partial void SDL_AddEventWatch(
			SDL_EventFilter filter,
			IntPtr userdata
		);
		...
		/* userdata refers to a void* */
		[LibraryImport(nativeLibName)]
		public static partial void SDL_DelEventWatch(
			SDL_EventFilter filter,
			IntPtr userdata
		);
		...
		/* userdata refers to a void* */
		[LibraryImport(nativeLibName)]
		public static partial void SDL_FilterEvents(
			SDL_EventFilter filter,
			IntPtr userdata
		);
        ...
        [DllImport(nativeLibName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "SDL_JoystickGetGUIDFromString")]
		private static unsafe extern Guid INTERNAL_SDL_JoystickGetGUIDFromString(
			byte* pchGUID
		);
		...
		[DllImport(nativeLibName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "SDL_GameControllerMappingForGUID")]
		...
		/* THIS IS AN RWops FUNCTION! */
		[DllImport(nativeLibName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "SDL_LoadWAV_RW")]
		...
		private static unsafe extern uint INTERNAL_SDL_OpenAudioDevice(
			byte* device,
			int iscapture,
		...
		)
		{
			...
			return INTERNAL_SDL_OpenAudioDevice(
				string.IsNullOrWhiteSpace(device) ? null : Utf8Encode(device, utf8Device, utf8DeviceBufSize),
				iscapture,
				ref desired,
				out obtained,
				allowed_changes
		...
		[LibraryImport(nativeLibName)]
		public static partial void SDL_SetWindowsMessageHook(
		...
		[LibraryImport(nativeLibName)]
		public static partial void SDL_HasARMSIMD();
