...
public unsafe sealed class FFFormatContext : CountedReference<AVFormatContext>
{
    ...
    public void OpenInput(string filePath, ref FFInputFormat format, FFDictionary formatOptions)
    {
        ...
        int resultCode;
        using (var contextPtr = AsDoublePointer())
    ...
    protected override unsafe void DisposeNative(AVFormatContext* target) =>
